    ...
    return (
        <div className={'hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full '}>
            <div className={'flex items-center justify-center w-14 h-14'}>
                <Image src={"https://rb.gy/ogau5a"} alt={'twitter logo'} width={30} height={30} className={"hoverAnimation"}/>
            </div>
            ...
            <div className={'flex items-center justify-center  hoverAnimation xl:ml-auto  mt-auto'}>
                <img src={'https://rb.gy/ogau5a'} alt="" className={'h-10 w-10 rounded-full xl:mr-2.5'}/>
=======
    const [activeLink, setActiveLink] = useState("Home")
